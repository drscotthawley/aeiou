...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'aeiou'},
  'syms': { 'aeiou.chunk_one_file': { 'aeiou.chunk_one_file.blow_chunks': ('chunk_one_file.html#blow_chunks', 'aeiou/chunk_one_file.py'),
                                      'aeiou.chunk_one_file.chunk_one_file': ( 'chunk_one_file.html#chunk_one_file',
                                                                               'aeiou/chunk_one_file.py')},
            'aeiou.chunkadelic': { 'aeiou.chunkadelic.blow_chunks': ('chunkadelic.html#blow_chunks', 'aeiou/chunkadelic.py'),
                                   ...
                                   'aeiou.chunkadelic.set_bit_rate': ('chunkadelic.html#set_bit_rate', 'aeiou/chunkadelic.py')},
            'aeiou.core': { 'aeiou.core.audio_float_to_int': ('core.html#audio_float_to_int', 'aeiou/core.py'),
                            ...
                            'aeiou.core.get_device': ('core.html#get_device', 'aeiou/core.py'),
                            'aeiou.core.get_latest_ckpt': ('core.html#get_latest_ckpt', 'aeiou/core.py'),
                            'aeiou.core.get_run_info': ('core.html#get_run_info', 'aeiou/core.py'),
                            ...
                            'aeiou.core.rnd_string': ('core.html#rnd_string', 'aeiou/core.py'),
            ...
            'aeiou.datasets': { 'aeiou.datasets.AudioDataset': ('datasets.html#audiodataset', 'aeiou/datasets.py'),
                                ...
                                'aeiou.datasets.AudioDataset.preload_files': ( 'datasets.html#audiodataset.preload_files',
                                                                               'aeiou/datasets.py'),
                                'aeiou.datasets.AudioWebDataLoader': ('datasets.html#audiowebdataloader', 'aeiou/datasets.py'),
                                ...
                                'aeiou.datasets.PadCrop_Normalized_T': ('datasets.html#padcrop_normalized_t', 'aeiou/datasets.py'),
                                'aeiou.datasets.PadCrop_Normalized_T.__call__': ( 'datasets.html#padcrop_normalized_t.__call__',
                                                                                  'aeiou/datasets.py'),
                                'aeiou.datasets.PadCrop_Normalized_T.__init__': ( 'datasets.html#padcrop_normalized_t.__init__',
                                                                                  'aeiou/datasets.py'),
                                'aeiou.datasets.PadCrop_Normalized_T_old': ('datasets.html#padcrop_normalized_t_old', 'aeiou/datasets.py'),
                                'aeiou.datasets.PadCrop_Normalized_T_old.__call__': ( 'datasets.html#padcrop_normalized_t_old.__call__',
                                                                                      'aeiou/datasets.py'),
                                'aeiou.datasets.PadCrop_Normalized_T_old.__init__': ( 'datasets.html#padcrop_normalized_t_old.__init__',
                                                                                      'aeiou/datasets.py'),
                                ...
                                'aeiou.datasets.get_all_s3_urls_zach': ('datasets.html#get_all_s3_urls_zach', 'aeiou/datasets.py'),
                                ...
                                'aeiou.datasets.get_wds_loader': ('datasets.html#get_wds_loader', 'aeiou/datasets.py'),
                                'aeiou.datasets.is_valid_sample': ('datasets.html#is_valid_sample', 'aeiou/datasets.py'),
                                'aeiou.datasets.log_and_continue': ('datasets.html#log_and_continue', 'aeiou/datasets.py'),
                                'aeiou.datasets.name_cache_file': ('datasets.html#name_cache_file', 'aeiou/datasets.py'),
            ...
            'aeiou.viz': { 'aeiou.viz.audio_spectrogram_image': ('viz.html#audio_spectrogram_image', 'aeiou/viz.py'),
                           ...
                           'aeiou.viz.point_cloud': ('viz.html#point_cloud', 'aeiou/viz.py'),
                           'aeiou.viz.print_stats': ('viz.html#print_stats', 'aeiou/viz.py'),
                           'aeiou.viz.proj_pca': ('viz.html#proj_pca', 'aeiou/viz.py'),
                           'aeiou.viz.project_down': ('viz.html#project_down', 'aeiou/viz.py'),
                           ...
                           'aeiou.viz.show_point_cloud': ('viz.html#show_point_cloud', 'aeiou/viz.py'),
